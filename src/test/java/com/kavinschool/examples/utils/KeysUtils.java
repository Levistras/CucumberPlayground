...
public class KeysUtils {
	...
	public KeysUtils(WebDriver driver) {
		super();
		this.driver = driver;
	}

	public void arrowLeft(final int numOfTimesToMove) {
	...
	public void arrowRight(final int numOfTimesToMove) {
		final Actions action = new Actions(driver);
		for (int i = 0; i < numOfTimesToMove; i++) {
	...
	public void downArrow(final int numOfTimesToMove) {
		final Actions action = new Actions(driver);
		for (int i = 0; i < numOfTimesToMove; i++) {
	...
	public void upArrow(final int numOfTimesToMove) {
		final Actions action = new Actions(driver);
		for (int i = 0; i < numOfTimesToMove; i++) {
